...
namespace SCP1356Main.API.Events
{
    public class CustomEvents
    {
        ...
        public static event EventHandler<HealthObjectDamaged> HealthObjectDamagedEvent;
        ...
        public static void InvokeHealthObjectDamaged(HealthObjectDamaged ev) => HealthObjectDamagedEvent?.Invoke(null, ev);
